...
const Navbar = () => {
  ...
  return (
    <nav className={`${theme == 'light' ? 'bg-light-background' : 'bg-dark-background text-white'} flex justify-between py-4 px-10`}>
        <div className='flex items-center'>
            <button onClick={toggleSidebar}>
                <i class="bi bi-list"></i>
            </button>
            <img src= {logo} style={{height: '23px'}} alt="logo" className='ml-4' />
        </div>
        <div className='flex items-center'>
            ...
            {
                theme == 'dark' ? <i class="bi bi-brightness-high"></i> : <i class="bi bi-moon-stars"></i>
            }
            </button>
        </div>
